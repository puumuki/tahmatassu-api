...
keys = {
	...
	'login.granted' : u'You have logged in',
	'login.denied' : u'Login failed, please try again',
	'logout.success' : u'You have logged out',
	'ask.recipe.howto': u'Search recipe from here, with a name: /recipe/:name'
}