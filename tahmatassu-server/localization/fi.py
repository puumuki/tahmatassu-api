...
keys = {
	...
	'login.granted' : u'Kirjautuminen onnistui',
	'login.denied' : u'Kirjautuminen epäonnistui, yritä uudelleen',
	'logout.success' : u'Olet kirjautunut ulos',
	'ask.recipe.howto': u'Oikea tapa etsiä reseptiä on: /recipe/:name'
}